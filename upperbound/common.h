...
#define MAX_THROUGHPUT 1
#define MAX_ALPHA      0
#define MAX_FAIR_SHARE 2
#define MAX_PROPORTIONAL_FAIR 3
...
static double cut_points[7] = {0, 0.01, 0.1, sqrt(0.1), 1, sqrt(10), 10};
static double slope[7] = {239.7895, 24.6358, 5.2930, 1.6806, 0.5321, 0.1683, 0.01};
static double width[7] = {0.0050, 0.050, 0.1531, 0.45, 1.423, 4.5};

static int num_cut_points = 7;
#endif
